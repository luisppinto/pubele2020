...
<body>
  ...
  <div style="align-self:center" class="nav">
    <table class="tab_nav">
      <tr>
        <th class="columnav"> <a href="/"><div class="hed"> Lista CDs</div></a></th>
        <th class="columnav"> <a href="/cds/novocd"><div class="hed"> Adicionar CDs</div></a></th>
        <th class="columnav"> <a href="/autores"><div class="hed">Informações Adicionais</div></a></th>
      </tr>
    </table>
  </div>
  <form action="/" method='POST'>
  <input type="text" name="userinput" placeholder="Procurar">
...
<div class="extrow">
    <div class="introw">
        <div class="column1">
          <a><img src={{p['artwork']}} alt="Album Artwork"></a>
        </div>

  <div class = "column2">
    <h3>{{p['artist']}}</h3>
    <h3>País: {{p['country']}} <img src="https://flagcdn.com/h20/{{p.country.lower()}}.png"></h3>
    <h3>Produtora: {{p['company']}}</h3>
    <h3>Descrição: {{p['description']}}</h3>
    <h3>Ano: {{p['year']}}</h3>
    <a href="/update/{{p.title}}">
      <button type ="submit"> Update </button>
    </a>
    <form action="/delete/{{p['title']}}" method="post">
      <button style="background-color:#a63a3a" type ="submit"> Delete </button>
    </form>
...
{% block body%}
    ...
    <form action="novocd" method='POST'>
        ...
        <input type="text" name="artwork" placeholder="inserir url da web"><br>
        <label>País</label><br>
